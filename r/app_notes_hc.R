...
# Event type and sources of payment -------------------------------------------
...
<p>Based on the question,Would you say [person's] health in general is excellent, very good, good, fair, or poor?</i>.</p>
"
...
demographics[["insurance"]] <-
  demographics[["ins_lt65"]] <-
  demographics[["ins_ge65"]] <- "
